...
(function () {
  ...
  function encode(text) {
    ...
    result = {
      text: out,
      bytes: null,
      filename: (loaded ? loaded.name : 'encoded') + '.txt',
      mime: 'text/plain'
    };
  ...
  $('#save').addEventListener('click', function () {
    ...
    var data =
      result.text !== null && result.bytes === null
        ? result.text
  ...
  ui.keys({
    ...
    'mod+shift+c': function () {
      if (result && result.text !== null) ui.copy(result.text);
    }
  });
